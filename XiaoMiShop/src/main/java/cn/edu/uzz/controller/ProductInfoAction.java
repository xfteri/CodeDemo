...
public class ProductInfoAction {
    ...
    @ResponseBody
    @RequestMapping(value = "/deleteAjaxSplit",produces = "text/html;charset=utf-8")//响应流可以用中文正确显示
    ...
    public String deleteBatch(String pids,HttpServletRequest request){
        //将获取到的传递的ids的字符，通过split去拆分字符串，得到商品的id的字符数组
        ...
        try {
            ...
            //如果批量删除的时候，选中了订单中的商品信息，那么提示不可以删除
